...
public class webresource {
	...
	public static void dosublinks(String t, String count) {
	...
	public static String request(String url) throws Exception {
		...
		conn2.setRequestProperty("cookie",
				"MPA3=1; _ga=GA1.2.136954141.1647589240; _gid=GA1.2.163485560.1647589240; terAgreementVer=1; TERLocationResolved=1; TerTzOffset=-420; TER%5FtestCookie=; language=en; TER%5FRememberPW=1; MsTerVer=6; cookieconsent_status=dismiss; TER%5Fusername=mingraham; TER%5Fhash=8OdI913oxsEJLWRRLLYHQSUKneB8L6vGp%2Fa8SadMjdx4QzatOvcGQJSnWZs714eWQcwwvCwEn%2BaSiXouCSMPzg%3D%3D; tz=Mountain+Standard+Time; TER%5FSearchGeoCityName=Los+Angeles%2C+CA; TER%5FSearchGeoCityId=city%2Dlos%2Dangeles%2Dca%2Dus; Upgraded=1; MsTerCounter=6; GUID=C1400F12BA24A549864A9BF56D86F951; K-GUID-pocpghie=09A0F0973C6C38D4117552EC1DCD4E51; TER%5Fsplash=1");
		return doreq(conn2);
	}
